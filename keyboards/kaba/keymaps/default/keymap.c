...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT(
//      /           /           /           /           /           /           /           /                       /           /           /           /           /           /           /           /
        QK_GESC,    KC_Q,       KC_W,       KC_E,       KC_R,       KC_T,                                                                   KC_Y,       KC_U,       KC_I,       KC_O,       KC_P,       KC_TAB,
...
//      /           /           /           /           /           /           /           /                       /           /           /           /           /           /           /           /
        QK_RBT,     _______,    KC_HOME,    KC_UP  ,    KC_END ,    KC_PGUP,                                                                KC_PSLS,    KC_P7,      KC_P8,      KC_P9,      KC_PMNS,    KC_PPLS,
                    _______,    KC_LEFT,    KC_DOWN,    KC_RGHT,    KC_PGDN,    _______,    _______,                KC_PENT,    _______,    KC_PAST,    KC_P4,      KC_P5,      KC_P6,      KC_PDOT,
                    _______,    _______,    _______,    _______,    _______,    _______,                                        MO(_Fn),    KC_PDOT,    KC_P1,      KC_P2,      KC_P3,      KC_P0
    ),

    [_Fn] = LAYOUT(
//      /           /           /           /           /           /           /           /                       /           /           /           /           /           /           /           /
        QK_RBT,     KC_CAPS,    KC_NUM ,    _______,    _______,    _______,                                                                KC_PSLS,    KC_F7,      KC_F8,      KC_F9,      KC_F12,     KC_PSCR,
                    _______,    _______,    _______,    _______,    _______,    _______,    _______,                _______,    _______,    KC_PAST,    KC_F4,      KC_F5,      KC_F6,      KC_F11,
